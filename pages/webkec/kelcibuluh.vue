<template>
  <div style="background-color: white">
    ...
    <div class="galeri">
      <h2>KELURAHAN <span>CIBULUH</span></h2>
        ...
        <b-tab title="Profil">
          ...
          <div class="profil">
            <div class="profil-lurah">
              <img
                src="~assets/img/cibuluh/lurah-cibuluh.png"
                alt="img-lurah"
              />
              <p
                class="nm-lurah"
              ...
              <p>
                ...
                resmi Website Kelurahan Cibuluh Kota Bogor. Website Kelurahan
                Cibuluh ini memuat Profil Kelurahan Cibuluh dan informasi
                penting berbagai program dan kegiatan Kelurahan Cibuluh Kota
            ...
            <div class="profil-content">
              <h5>Luas Wilayah :</h5>
              <p>
                Luas Wilayah Kelurahan Cibuluh tercatat seluas 153,8Ha yang
                terdiri dari 9 RW (RukunWilayah) dan 47 RT (Rukun Tetangga),
                dengan batas-batas sebagai berikut: Sebelah Utara : Kelurahan
                Ciluar dan Sukaraja Kab.Bogor Sebelah Selatan : Kelurahan Tegal
                Gundil dan Kelurahan Bantarjati, Sebelah Timur : Berbatasan
                dengan Kelurahan Tanah Baru, Sebelah Barat : Kelurahan Ciparigi
                dan Kelurahan KedungHalang
              </p>
              <div class="profil-visi">
                <h5>Visi & Misi</h5>
                <p>
                  <span>Visi : </span>"Berkembangnya usaha/jasa dan transportasi
                  yang nyaman dengan masyarakat yang madani dan Pemerintah
                  Kelurahan yang amanah."
                </p>
                <p>
                  <span>Misi : </span> Mewujudkan pelayanan yang prima kepada
                  masyarakat dengan menjunjung tinggi supremasi hukum.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="album">
              ...
              <b-modal id="bv-modal-example" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  ...
                  <p class="text-center">Nama Posyandu : Delima I</p>
                  <p>
                  ...
                  <p>Lokasi :KP. PANGKALAN RT.05 RW.01</p>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d247.73685898274877!2d106.814566!3d-6.548211!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c5d7db242e25%3A0x782cefcd6d52c7a8!2sPosyandu%20Subagenda!5e0!3m2!1sid!2sid!4v1717686213565!5m2!1sid!2sid"
                    width="100%"
                    height="250"
                    style="border: 0"
                    allowfullscreen=""
            ...
            <div class="album">
              ...
              <b-modal id="bv-modal-example-2" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  ...
                  <p class="text-center">Nama Posyandu : Alfiat I</p>
                  <p>
                    Strata : Posyandu Purnama adalah Posyandu yang sudah dapat
                    melaksanakan kegiatan lebih dari 8 kali per tahun, dengan
                    rata-rata jumlah kader sebanyak lima orang atau lebih,
                  ...
                  <p>
                    Lokasi : KP.CIBULUH RT.03 RW.03 Kelurahan Cibuluh Kecamatan
                    Bogor Utara
                  </p>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d247.73685898274877!2d106.814566!3d-6.548211!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c5d7db242e25%3A0x782cefcd6d52c7a8!2sPosyandu%20Subagenda!5e0!3m2!1sid!2sid!4v1717686213565!5m2!1sid!2sid"
              ...
              <b-modal id="bv-modal-example-3" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  <img
                    ...
                    alt=""
                  />
                  <p class="text-center">Nama Posyandu : Alfiat II</p>
                  <p>
                    Strata : Posyandu Purnama adalah Posyandu yang sudah dapat
                    melaksanakan kegiatan lebih dari 8 kali per tahun, dengan
                    rata-rata jumlah kader sebanyak lima orang atau lebih,
                  ...
                  <p>
                    Lokasi : KP.CIBULUH RT.01 RW.03 Kelurahan Cibuluh Kecamatan
                    Bogor Utara
                  </p>
                </div>
                <b-button
            ...
            <div class="album">
              ...
              <b-modal id="bv-modal-example-4" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  ...
                  <p class="text-center">Nama Posyandu : Anggerek Putih II</p>
                  <p>
                    Strata : Posyandu Purnama adalah Posyandu yang sudah dapat
                    melaksanakan kegiatan lebih dari 8 kali per tahun, dengan
                    rata-rata jumlah kader sebanyak lima orang atau lebih,
                  ...
                  <p>
                    Lokasi : KP. PANGKALAN RAYA RT.06 RW.02 Kelurahan Cibuluh
        ...
        <b-tab title="Kontak">
          <div class="kontak">
            ...
            <div class="kontak-content">
              <p>
                <span>Alamat : </span>Jl. Pangeran Sogiri RT 01 / 04, Bogor
                Utara,Bogor
              </p>

              <p><span>No Telepon : </span> 0251 - 8653235</p>

              <p><span>Email: </span>kel.cibuluh@kotabogor.go.id</p>
            </div>
          </div>
        </b-tab>
      </b-tabs>
...
export default {
  ...
  head() {
    return {
      title: "Kelurahan Cibuluh | Kecamatan Bogor Utara",
      meta: [
        {
          hid: "og:title",
          name: "og:title",
