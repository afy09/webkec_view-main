<template>
  <div style="background-color: white">
    ...
    <div class="galeri">
      <h2>KELURAHAN <span>TANAH BARU</span></h2>
        ...
        <b-tab title="Profil">
          ...
          <div class="profil">
            <div class="profil-lurah">
              <img
                src="~assets/img/tanahbaru/lurah-tbaru.png"
                alt="img-lurah"
              />
              <p
                class="nm-lurah"
              ...
              <p>
                ...
                resmi Website Kelurahan Tanah Baru Kota Bogor. Website Kelurahan
                Tanah Baru ini memuat Profil Kelurahan Tanah Baru dan informasi
                penting berbagai program dan kegiatan Kelurahan Tanah Baru Kota
                Bogor, Kami harap website ini dapat bermanfaat dalam memberikan
                data dan informasi yang dapat digunakan oleh masyarakat.
              </p>
            </div>
            ...
            <div class="profil-content">
              <h5>Luas Wilayah :</h5>
              <p>
                Luas Wilayah Kelurahan Bantarjati tercatat seluas 3,26 KM2,
                dengan batas-batas sebagai berikut: Sebelah Utara : Kelurahan
                Cibuluh dan Kelurahan Ciluar, Sebelah Selatan : Kelurahan
                Katulampa dan Kelurahan Baranangsiang, Sebelah Timur : Kelurahan
                Cimahpar, Sebelah Barat : Kelurahan Tegallega dan Kelurahan
                Tegal Gundil
              </p>
              <div class="profil-visi">
                <h5>Visi & Misi</h5>
                <p>
                  <span>Visi : </span>"Mewujudkan Kota Bogor sebagai Kota Ramah
                  Keluarga"
                </p>
                <p>
                  <span>Misi : </span>
                </p>
                <p class="p-misi">1. Mewujudkan Kota yang Sehat</p>
                <p class="p-misi">2.Mewujudkan Kota yang Cerdas</p>
                <p class="p-misi">3. Mewujudkan Kota yang Sejahtera</p>
              </div>
            </div>
          </div>
        </b-tab>
          ...
          <div class="galeri-foto">
            <div class="album">
              <div class="album-img">
                <a
                  ><img
                    src="~assets/img/tanahbaru/pos-mekarsari.png"
                    alt=""
                    id="show-btn"
              ...
              <b-modal id="bv-modal-example" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  <img src="~assets/img/tanahbaru/pos-mekarsari.png" alt="" />
                  <p class="text-center">Nama Posyandu : Mekarsari</p>
                  <p>
                  ...
                  <p>
                    Lokasi : KP.SIDANGSARI RT. 004 Rw 002 Kelurahan Tanah Baru
            ...
            <div class="album">
              <div class="album-img">
                <a
                  ><img
                    src="~assets/img/tanahbaru/pos-dahlia.png"
                    alt=""
                    id="show-btn"
              ...
              <b-modal id="bv-modal-example-2" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  <img src="~assets/img/tanahbaru/pos-dahlia.png" alt="" />
                  <p class="text-center">Nama Posyandu : Dahlia</p>
                  <p>
                  ...
                  <p>
                    Lokasi : KP.SALAWI RT 003 RW 003 Kelurahan Tanh BARU
                    Kecamatan Bogor Utara
                  </p>
                </div>
                <b-button
            ...
            <div class="album">
              <div class="album-img">
                <a
                  ><img
                    src="~assets/img/tanahbaru/pos-sakura.png"
                    alt=""
                    id="show-btn"
              ...
              <b-modal id="bv-modal-example-3" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  <img src="~assets/img/tanahbaru/pos-sakura.png" alt="" />
                  <p class="text-center">Nama Posyandu : Sakura</p>
                  <p>
                    Strata : Posyandu Purnama adalah Posyandu yang sudah dapat
                    melaksanakan kegiatan lebih dari 8 kali per tahun, dengan
                    rata-rata jumlah kader sebanyak lima orang atau lebih,
                  ...
                  <p>
                    Lokasi : BTN TNB BLOK E RT 005 RW 008 Kelurahan Tanah Baru
                    Kecamatan Bogor Utara
                  </p>
                </div>
                <b-button
            ...
            <div class="album">
              <div class="album-img">
                <a
                  ><img
                    src="~assets/img/tanahbaru/pos-hanjuang-b.png"
                    alt=""
                    id="show-btn"
              ...
              <b-modal id="bv-modal-example-4" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  <img src="~assets/img/tanahbaru/pos-hanjuang-b.png" alt="" />
                  <p class="text-center">Nama Posyandu : Hanjuang B</p>
                  <p>
                    Strata : Posyandu Purnama adalah Posyandu yang sudah dapat
                    melaksanakan kegiatan lebih dari 8 kali per tahun, dengan
                    rata-rata jumlah kader sebanyak lima orang atau lebih,
                  ...
                  <p>
                    Lokasi : TANAH BARU RT 003 RW 004 Kelurahan Tanah Baru
                    Kecamatan Bogor Utara
                  </p>
                </div>
                <b-button
        ...
        <b-tab title="Kontak">
          <div class="kontak">
            ...
            <div class="kontak-content">
              <p>
                <span>Alamat : </span> Jl.Pangeran Sogiri No.374 RT.004 RW.002
                Kel.Tanah Baru Kec.bogor Utara Kota Bogor
              </p>

              <p><span>No Telepon : </span></p>

              <p><span>Email: </span>kel.tanahbaru@kotabogor.go.id</p>
            </div>
          </div>
        </b-tab>
      </b-tabs>
