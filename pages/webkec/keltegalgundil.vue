<template>
  <div style="background-color: white">
    ...
    <div class="galeri">
      <h2>KELURAHAN <span>TEGAL GUNDIL</span></h2>
        ...
        <b-tab title="Profil">
          ...
          <div class="profil">
            <div class="profil-lurah">
              <img
                src="~assets/img/tegalgundil/lurah-tgundil.png"
                alt="img-lurah"
              />
              <p
                class="nm-lurah"
              ...
              <p>
                ...
                resmi Website Kelurahan Tegal Gundil Kota Bogor. Website
                Kelurahan Tegal Gundil ini memuat Profil Kelurahan Tegal Gundil
                dan informasi penting berbagai program dan kegiatan Kelurahan
                Tegal Gundil Kota Bogor, Kami harap website ini dapat bermanfaat
            ...
            <div class="profil-content">
              <h5>Luas Wilayah :</h5>
              <p>
                Luas Wilayah Kelurahan Bantarjati tercatat seluas 190 Ha yang
                terdiri dari 17 RW (RukunWilayah) dan 97 RT (Rukun Tetangga),
                dengan batas-batas sebagai berikut: Sebelah Utara : Berbatasan
                dengan Kel. Cibuluh, Sebelah Selatan : Berbatasan dengan Kel.
                Tanah Sareal Sebelah Timur : Berbatasan denagan Kel. Babakan,
                Sebelah Barat : Berbatasan dengan Kel. Bantarjati
              </p>
              <div class="profil-visi">
                <h5>Visi & Misi</h5>
                <p>
                  <span>Visi : </span>"Menjadikan Kel. Pemukiman yang Asri
                  Berbasis Pengembangan SDM dan Produksi Home Industri."
                </p>
                <p>
                  <span>Misi : </span>
                </p>
                <p class="p-misi">1. Mewujudkan Kelurahan yang Sehat.</p>
                <p class="p-misi">2.Menigkatkan Pendapatan yang Berkapita.</p>
                <p class="p-misi">3. Menurunkan Angka Pengangguran.</p>
                <p class="p-misi">4. Menigktakan Wajar Diatas 9 Tahun.</p>
              </div>
            </div>
          </div>
        </b-tab>
          ...
          <div class="galeri-foto">
            <div class="album">
              <div class="album-img">
                <a
                  ><img
                    src="~assets/img/tegalgundil/pos-durian.png"
                    alt=""
                    id="show-btn"
              ...
              <b-modal id="bv-modal-example" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  <img src="~assets/img/tegalgundil/pos-durian.png" alt="" />
                  <p class="text-center">Nama Posyandu : Durian</p>
                  <p>
                    Strata : Posyandu Mandiri adalah Posyandu yang sudah dapat
                    ...
                    tinggal di wilayah kerja Posyandu. Intervensi yang dilakukan
                    bersifat pembinaan termasuk pembinaan program dana sehat,
                    sehingga terjamin kesinambungannya. Selain itu dapat
                    dilakukan intervensi memperbanyak macam program tambahan
                    sesuai dengan masalah dan kemampuan masing-masing
                  </p>
                  <p>
                    VILLA CITRA RT.05 RW.04 Kelurahan Tegal Gundil Kecamatan
                    Bogor Utara
                  </p>
                </div>
                <b-button
            ...
            <div class="album">
              <div class="album-img">
                <a
                  ><img
                    src="~assets/img/tegalgundil/pos-delima.png"
                    alt=""
                    id="show-btn"
              ...
              <b-modal id="bv-modal-example-2" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  <img src="~assets/img/tegalgundil/pos-delima.png" alt="" />
                  <p class="text-center">Nama Posyandu : Dalima</p>
                  <p>
                  ...
                  <p>
                    Lokasi : JL.TATAPAKAN RAYA RT.04 RW.10 Kelurahan Tegal
                    Gundil Kecamatan Bogor Utara
                  </p>
                </div>
                <b-button
                  class="mt-3"
            ...
            <div class="album">
              <div class="album-img">
                <a
                  ><img
                    src="~assets/img/tegalgundil/pos-apel.png"
                    alt=""
                    id="show-btn"
              ...
              <b-modal id="bv-modal-example-3" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  <img src="~assets/img/tegalgundil/pos-apel.png" alt="" />
                  <p class="text-center">Nama Posyandu : Apel</p>
                  <p>
                    Strata : Posyandu Purnama adalah Posyandu yang sudah dapat
                    melaksanakan kegiatan lebih dari 8 kali per tahun, dengan
                    rata-rata jumlah kader sebanyak lima orang atau lebih,
                  ...
                  <p>
                    Lokasi : JL.PALAYU RT.01 RW.07 Kelurahan Tegal Gundil
            ...
            <div class="album">
              <div class="album-img">
                <a
                  ><img
                    src="~assets/img/tegalgundil/pos-manggis.png"
                    alt=""
                    id="show-btn"
              ...
              <b-modal id="bv-modal-example-4" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  <img src="~assets/img/tegalgundil/pos-manggis.png" alt="" />
                  <p class="text-center">Nama Posyandu : Manggis</p>
                  <p>
                    Strata : Posyandu Purnama adalah Posyandu yang sudah dapat
                    melaksanakan kegiatan lebih dari 8 kali per tahun, dengan
                    rata-rata jumlah kader sebanyak lima orang atau lebih,
                  ...
                  <p>
                    Lokasi : JL.TAMAN BARU RT.02 RW.08 Kelurahan Tegal Gundil
                    Kecamatan Bogor Utara
                  </p>
                </div>
                <b-button
        ...
        <b-tab title="Kontak">
          <div class="kontak">
            ...
            <div class="kontak-content">
              <p><span>Alamat : </span> Jl. Arztimar II No.3</p>

              <p><span>No Telepon : </span> 0251-8376340</p>

              <p><span>Email: </span>kel.tegalgundil@kotabogor.go.id</p>
            </div>
          </div>
        </b-tab>
      </b-tabs>
...
export default {
  ...
  head() {
    return {
      title: "Kelurahan Cimahpar | Kecamatan Bogor Utara",
      meta: [
        {
          hid: "og:title",
          name: "og:title",
