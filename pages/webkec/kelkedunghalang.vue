<template>
  <div style="background-color: white">
    ...
    <div class="galeri">
      <h2>KELURAHAN <span>KEDUNG HALANG</span></h2>
        ...
        <b-tab title="Profil">
          ...
          <div class="profil">
            <div class="profil-lurah">
              <img
                src="~assets/img/kedunghalang/lurah-khalang.png"
                alt="img-lurah"
              />
              <p
                class="nm-lurah"
              ...
              <p>
                ...
                resmi Website Kelurahan Kedung Halang Kota Bogor. Website
                Kelurahan Kedung Halang ini memuat Profil Kelurahan Kedung
                Halang dan informasi penting berbagai program dan kegiatan
                Kelurahan Kedung Halang Kota Bogor, Kami harap website ini dapat
                bermanfaat dalam memberikan data dan informasi yang dapat
            ...
            <div class="profil-content">
              <h5>Luas Wilayah :</h5>
              <p>
                Luas Wilayah Kelurahan kedung Halang tercatat seluas + 192 ha
                yang terdiri dari 15 RW (RukunWilayah) dan 77 RT (Rukun
                Tetangga), dengan batas-batas sebagai berikut: Sebelah Utara :
                Desa Pasir Jambu Kecamatan Sukaraja, Sebelah Selatan : Kelurahan
                Cibuluh Kecamatan Bogor Utara, Sebelah Timur : Kelurahan
                Ciparigi Kecamatan Tanah Sareal, Sebelah Barat : Kelurahan
                Sukaresmi Kecamatan Tanah Sareal
              </p>
              <div class="profil-visi">
                <h5>Visi & Misi</h5>
                <p>
                  <span>Visi : </span>"Mewujudkan Kelurahan Kedung Halang
                  sebagai Wilayah Pemukiman dan Jasa Perdagangan."
                </p>
                <p>
                  <span>Misi : </span>
                </p>
                <p class="p-misi">1. Penataan pemukiman yang asri.</p>
                <p class="p-misi">
                  2. Menggerakkan seluruh masyarakat peduli lingkungan.
                </p>
                <p class="p-misi">3. Memberikan pelayanan yang prima.</p>
                <p class="p-misi">
          ...
          <div class="galeri-foto">
            <div class="album">
              <div class="album-img">
                <a
                  ><img
                    src="~assets/img/kedunghalang/pos-indah-1.png"
                    alt=""
                    id="show-btn"
              ...
              <b-modal id="bv-modal-example" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  <img src="~assets/img/kedunghalang/pos-indah-1.png" alt="" />
                  <p class="text-center">Nama Posyandu : Nusa Indah I</p>
                  <p>
                  ...
                  <p>
                    Lokasi :RT 04 RW 01 Kelurahan Kedung Halang Kecamatan Bogor
                    Utara
                  </p>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7927.446050861523!2d106.80099775851886!3d-6.556607206891563!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c41b39b84e6f%3A0x62ed12752341541!2sRW.04%2C%20Kedunghalang%2C%20Kec.%20Bogor%20Utara%2C%20Kota%20Bogor%2C%20Jawa%20Barat!5e0!3m2!1sid!2sid!4v1717730820792!5m2!1sid!2sid"
                    width="100%"
                    height="400"
                    style="border: 0"
                    allowfullscreen=""
            ...
            <div class="album">
              <div class="album-img">
                <a
                  ><img
                    src="~assets/img/kedunghalang/pos-indah-2.png"
                    alt=""
                    id="show-btn"
              ...
              <b-modal id="bv-modal-example-2" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  <img src="~assets/img/kedunghalang/pos-indah-2.png" alt="" />
                  <p class="text-center">Nama Posyandu : Nusa Indah II</p>
                  <p>
                    Strata : Posyandu Purnama adalah Posyandu yang sudah dapat
                    melaksanakan kegiatan lebih dari 8 kali per tahun, dengan
                    rata-rata jumlah kader sebanyak lima orang atau lebih,
                  ...
                  <p>
                    Lokasi : RT 06 RW 01 Kelurahan Kedung Halang Kecamatan Bogor
                    Utara
                  </p>
                </div>
                <b-button
            ...
            <div class="album">
              <div class="album-img">
                <a
                  ><img
                    src="~assets/img/kedunghalang/pos-sari-2.png"
                    alt=""
                    id="show-btn"
              ...
              <b-modal id="bv-modal-example-3" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  <img src="~assets/img/kedunghalang/pos-sari-2.png" alt="" />
                  <p class="text-center">Nama Posyandu : Mekar Sari II</p>
                  <p>
                    Strata : Posyandu Purnama adalah Posyandu yang sudah dapat
                    melaksanakan kegiatan lebih dari 8 kali per tahun, dengan
                    rata-rata jumlah kader sebanyak lima orang atau lebih,
                  ...
                  <p>
                    Lokasi : RT 03 RW 05 Kelurahan Kedung Halang Kecamatan Bogor
                    Utara
                  </p>
                </div>
                <b-button
            ...
            <div class="album">
              <div class="album-img">
                <a
                  ><img
                    src="~assets/img/kedunghalang/pos-tanjung-1.png"
                    alt=""
                    id="show-btn"
              ...
              <b-modal id="bv-modal-example-4" hide-footer>
                ...
                <div id="modal" class="d-block text-center">
                  <img
                    ...
                    alt=""
                  />
                  <p class="text-center">Nama Posyandu : Tanjung I</p>
                  <p>
                    Strata : Posyandu Purnama adalah Posyandu yang sudah dapat
                    melaksanakan kegiatan lebih dari 8 kali per tahun, dengan
                    rata-rata jumlah kader sebanyak lima orang atau lebih,
                  ...
                  <p>
                    Lokasi : RT 02 RW 07 Kelurahan Kedung Halang Kecamatan Bogor
                    Utara
                  </p>
                </div>
                <b-button
        ...
        <b-tab title="Kontak">
          <div class="kontak">
            ...
            <div class="kontak-content">
              <p>
                <span>Alamat : </span>Jl. Raya Kedung Halang No.03, Bogor Utara
              </p>

              <p><span>No Telepon : </span>0251 - 8660272</p>

              <p><span>Email: </span>kel.kedunghalang@kotabogor.go.id</p>
            </div>
          </div>
        </b-tab>
      </b-tabs>
...
export default {
  ...
  head() {
    return {
      title: "Kelurahan Kedung Halang | Kecamatan Bogor Utara",
      meta: [
        {
          hid: "og:title",
          name: "og:title",
